...
<template>
  <div class="wrapper">
    ...
    <CurrentWork
      ...
      duration="Completed"
      description="Developing a new application for The Mash Tun Pub. The owner supplies monthly updates of their promotions and events."
    ...
    />
    <strong
      class="flex flex-col items-center work-header"
      style="padding-bottom: 0"
      >Previous Work</strong
    >
    <p class="work-intro">
      Click on the cards below to reveal work descriptions at bottom of screen.
    </p>
    <div class="flex flex-wrap">
      ...
      >
        ...
        <WorkItem
          ...
          tech3="ES6"
          imgResise
          @click="toggleFlag('showArnoldClark')"
        />
        <!-- Column 3 lloyds -->
        <WorkItem
          :logoSrc="lloydsLogo"
        ...
        <WorkItem
          ...
          tech3="ES6"
          @click="toggleFlag('showConnectAuto')"
        />
      </div>
    </div>
...
export default {
  ...
  methods: {
    toggleFlag(flagName) {
      ...
      this.resetFlags(flagName);
    },
    resetFlags(flagName) {
      Object.keys(this.$data).forEach((key) => {
        if (key !== flagName && key.startsWith("show")) {
          this[key] = false;
        }
      });
    },
